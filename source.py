...
HANDLERS = {}
SKIP_CODE = ('Пропуск ⏭️',)
THRESHOLD_AVG_ANOMALY_VIEWS = 0.65
START_AVG_COUNT_HOURS = 24
START_ANOMALY_COUNT_HOURS = 12
MAX_AVG_POSTS_CHECK = 30
POSTS_FOR_AVG = 10
DEFAULT_MAX_UNIQ_REAC = 5
MAX_CONCURRENT_REQS = 30
