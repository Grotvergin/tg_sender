...
TIME_FRACTION = 0.15
ACCOUNTS_LEN = 0
MONITOR_INTERVAL_MINS = 120
MONITOR_SILENCE_TIME = 60
POSTS_TO_CHECK = 10
...
ANOMALY_PID_FILE = 'anomaly.pid'
MAIN_SCRIPT_NAME = 'main_run.sh'
ANOMALY_SCRIPT_NAME = 'anomaly_run.sh'
MAIN_SCREEN_NAME = 'sender'
ANOMALY_SCREEN_NAME = 'anomaly'
MONITOR_TYPES = ('m', 'a')
BOT = TeleBot(TOKEN)
